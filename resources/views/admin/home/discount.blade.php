    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">اضافة كود خصم</h5>
...
<tbody><tr>
    ...
    <td class="allb">{{$item['discount']}}</td>
    <td class="allb">{{$item['validity']==1 ? "فعال":"غير فعال"}}</td>
    <td class="allb">
        <a class="btn btn-danger" href="/admin/discount/delete/{{$item['id']}}">حذف</a>
    </td>
