    ...
    <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td ><div class="mt-4">{{$item['reciver_name']}}</div></td>
            <td><img style="width: 80px;height:80px"  src="{{ asset('storage/'. $item['image']) }}"/></td>
            <td>
                <div class="d-flex flex-row mt-4">
                    <div ><a href="/admin/office/edit/{{$item['id']}}"  class="btn btn-primary">
                      <i style="color: white" class="material-icons ">تعديل</i>
                    </a></div>
                    <div ><a href="/admin/office/delete/{{$item['id']}}" class="btn btn-danger mr-1">
      ...
      <a href="/admin/office/add" class="btn btn-primary" style="color: white"> اضافة المزيد</a>
</div>
